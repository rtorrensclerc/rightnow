...
<rn:meta title="#rn:msg:CUSTOM_MSG_COMMERCIAL_CONTACT#" template="2020.php" clickstream="form_request_commercial" login_required="false" />
  ...
  <div class="rn_PageContentInner">
    <rn:condition logged_in="false">
      <div class="ask-in-login">
        ...
        <rn:widget path="custom/login/LoginFormMouldable" redirect_url="/app/sv/request/commercial" />
      </div>
    </rn:condition>
    <div id="rn_ErrorLocation" style="display:none;"></div>
    <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">

      #rn:msg:CUSTOM_MSG_ASSISTANT_COMERCIAL_TXT#
      ...
      <fieldset>
        ...
        <div class="form-content">
          ...
          <!--div class="rn_Hidden" hidden="hidden" styles="display:none;">
            <rn:widget path="input/FormInput" name="Incident.Subject" required="true" label_input="Asunto" default_value="Contacto Comercial" />
          </div-->
