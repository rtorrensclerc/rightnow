...
<div class="rn_PageHeader">
    <div class="rn_Container">
        <h1>#rn:msg:CUSTOM_MSG_LAST_REQUESTS#</h1>
    </div>
</div>
...
<div id="rn_PageContent rn_Home">
    <div class="rn_Padding column">
      <rn:widget path="custom/reports/IntegerGrid" report_id="100835" json_filters="#rn:php:json_encode($a_Filters1)#" per_page="20" />
    </div>
</div>
