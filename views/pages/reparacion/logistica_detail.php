...
<div class="rn_PageHeader">
  <div class="rn_PageHeaderInner">
    <h1 class="rn_Summary" itemprop="name">Detalle Despacho<?= \RightNow\Utils\Url::getParameter('ref_no') ?></h1>
  </div>
</div>
<div class="rn_PageContent">
  <rn:widget path="custom/integer/LogisticTicket" ref_no="#rn:php:\RightNow\Utils\Url::getParameter('ref_no')#" />
</div>
