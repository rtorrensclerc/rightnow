...
<div class="rn_PageHeader">
    <div class="rn_Container">
        <h1>#rn:msg:CUSTOM_MSG_ACTIVE_ATTENTIONS#</h1>
    </div>
</div>
...
<div id="rn_PageContent rn_Home">
    <div class="rn_Padding column">
      <rn:widget path="custom/reports/IntegerGrid" report_id="100715" json_filters="#rn:php:json_encode($a_Filters1)#" per_page="200" show_paginator="false" url_per_col="/app/reparacion/request_detail/ref_no/" col_id_url="1" />
    </div>
</div>
