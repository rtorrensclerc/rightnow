...
class SendPPTOToARHandler
{
    ...
    //URL de Producción:
    //CONST URL          = "http://190.14.56.27:8080//dts/rn_integracion/rntelejson.php";
    CONST URL  = "https://soportedimacoficl.custhelp.com/cc/OportunitiesServices/SendPPTOToAR/op_id/";
    ...
    static function HandleOpportunity($runMode, $action, $opportunity, $cycle)
    {
      ...
      try
      {
        $url = self::URL.$opportunity->ID;
        self::insertPrivateNote($opportunity, "[" . date("Y/m/d H:i:s") . "][INC: " . $opportunity->ID . "]: Inicia CPM de ");
       
        ConnectUrl::requestGet($url);
    ...
    static function HandleOpportunity_back($runMode, $action, $opportunity, $cycle)
    {
