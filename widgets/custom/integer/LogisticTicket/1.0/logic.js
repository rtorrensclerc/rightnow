RightNow.namespace('Custom.Widgets.integer.LogisticTicket');
Custom.Widgets.integer.LogisticTicket = RightNow.Widgets.extend({
    /**
     * Widget constructor.
     */
  ...
  xhr.send(formData);
     ...
     _cancel: function(e) {
      ...
      _request: function(e) {
        ...
        RightNow.Ajax.makeRequest('/cc/Services/updateIncidentLogistica', {
