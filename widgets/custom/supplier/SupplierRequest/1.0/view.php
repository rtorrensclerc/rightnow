	...
	<div class="rn_ScreenForm">
      ...
      <? endif; ?>
          ...
          <rn:widget 		path="custom/input/SelectField" 					id="hh_brand_list" 		name="hh_brand_list" 		label_input="#rn:msg:CUSTOM_MSG_SUPPLIER_REQUEST_SELECT_BRAND_HH#" 																								required="true" disabled="false" />
		      ...
		      <rn:widget 	path="custom/input/InputField" placeholder="0" 		id="hh_counter_bw" 		name="hh_counter_bw" 		label_input="#rn:msg:CUSTOM_MSG_SUPPLIER_REQUEST_BN_COUNTER#" 		value="#rn:php:$this->data['hh_counter_bw']#" 												required="true" disabled="false" 	display_type="number" maxlength="8" max_value="15000000" />
		      <rn:widget 	path="custom/input/InputField" placeholder="0" 		id="hh_counter_color" 	name="hh_counter_color" 	label_input="#rn:msg:CUSTOM_MSG_SUPPLIER_REQUEST_COLOR_COUNTER#" 	value="#rn:php:(($this->data['hh_counter_color'])?$this->data['hh_counter_color']:'0')#" 	required="true" disabled="false" 	display_type="number" maxlength="8" max_value="15000000" />
          <? else: ?>
            ...
            <rn:widget 		path="custom/input/InputField" placeholder="0" 		id="hh_counter_bw" 		name="hh_counter_bw" 		label_input="#rn:msg:CUSTOM_MSG_SUPPLIER_REQUEST_BN_COUNTER#" 		value="#rn:php:$this->data['hh_counter_bw']#" 																disabled="false" 	display_type="number" maxlength="8" max_value="15000000" />
            <rn:widget 		path="custom/input/InputField" placeholder="0" 		id="hh_counter_color" 	name="hh_counter_color" 	label_input="#rn:msg:CUSTOM_MSG_SUPPLIER_REQUEST_COLOR_COUNTER#" 	value="#rn:php:(($this->data['hh_counter_color'])?$this->data['hh_counter_color']:'')#" 					disabled="false" 	display_type="number" maxlength="8" max_value="15000000" />
		      <? endif; ?>
		      <? if(!$this->data['attrs']['read_only']): ?>
