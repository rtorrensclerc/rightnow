...
<? else: ?>
<div id="rn_<?= $this->instanceID ?>" class="<?= $this->classList ?> rn_TextInput-<?= $this->data['attrs']['display_type'] ?>">
<rn:block id="top"/>
...
<? else: ?>
<rn:block id="preInput"/>
    <input type="<?=$this->data['inputType']?>" id="rn_<?=$this->instanceID?>_<?=$this->data['js']['name']?>" name="<?= $this->data['inputName'] ?>" class="rn_<?=$this->data['displayType']?>" <?=$this->outputConstraints();?> <?if($this->data['value'] !== null && $this->data['value'] !== '') echo "value='{$this->data['value']}'";?> placeholder="<?= $this->data['attrs']['placeholder'] ?>" />
<rn:block id="postInput"/>
<? if ($this->data['attrs']['hint'] && $this->data['attrs']['always_show_hint']): ?>
    <rn:block id="preHint"/>
    <span class="rn_HintText" aria-hidden="true"><?= $this->data['attrs']['hint'] ?></span>
...
<? endif; ?>
    ...
    <div class="rn_TextInputValidate">
        ...
        <input type="<?= $this->data['inputType'] ?>" id="rn_<?= $this->instanceID ?>_<?= $this->data['js']['name'] ?>_Validate" name="<?= $this->data['inputName'] ?>_Validation" class="rn_<?=$this->data['displayType']?> rn_Validation" <?= $this->outputConstraints(); ?> value="<?= $this->data['value'] ?>" placeholder="<?= $this->data['attrs']['placeholder'] ?>" />
