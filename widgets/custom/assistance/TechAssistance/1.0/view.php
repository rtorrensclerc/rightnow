...
<div id="rn_<?=$this->instanceID?>" class="<?=$this->classList?> form-request">
	<div class="rn_ScreenForm">
		...
		<?if($kw):?>
		<rn:widget path="custom/Info/knowledgebase" />
		<?endif;?>
		<div class="message">
      ...
      <? endif; ?>
		  ...
		  <fieldset class="rn_StepGroup rn_Step2"<?= $hidde_init ?>>
		    <div class="form-content">
		      <legend>#rn:msg:CUSTOM_MSG_OFFICE_INFO#</legend>
          ...
          <rn:widget path="custom/input/InputField" id="contact_phone" name="contact_phone" label_input="Teléfono" value="#rn:php:$this->data['contact_phone']#" required="true" disabled="false" maxlength="9" display_type="number" />
		  ...
		  <fieldset class="rn_StepGroup rn_Step2"<?= $hidde_init ?>>
		    <div class="form-content">
					...
					<rn:widget path="custom/input/SelectField" id="suggested_type" name="suggested_type" label_input="Motivo"  required="true" disabled="false" wide="false" />
    ...
    <div class="rn_ScreenSuccess rn_StepGroup rn_Step3" style="display: none;" hidden="hidden">
      ...
      <div class="rn_PageContent rn_Home rn_Wraper">
        ...
        <div class="rn_SuccessMesage">
          <div class="message">
            ...
            <br>
            <p class="message_phone" style="display:none;" hidden="hidden">
              #rn:msg:CUSTOM_MSG_REQ_PHO_SUP_REQUEST_MSG#
            </p>
          </div>
          <div class="icon"></div>
        </div>
