...
class DigitalAssistance extends \RightNow\Libraries\Widget\Base
{
  ...
  function getData()
  {
    ...
    $this->data['contact_email'] = $contact->Emails[0]->Address ;
  ...
  private function setMenulist()
  {
    ...
    if ($result === FALSE)
    {
      echo $this->CI->TechAssistance->getLastError();
    } 
    else 
    {
      foreach ($result as $dir) 
      {
        $a_tempDir ["name"]                     = $dir->dir_envio;
