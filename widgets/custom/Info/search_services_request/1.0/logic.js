RightNow.namespace('Custom.Widgets.Info.search_services_request');
Custom.Widgets.Info.search_services_request = RightNow.Widgets.extend({     /**
     * Widget constructor.
     */
    constructor: function () {
        // Variables

        window.search_services_request = this;
