...
<div id="rn_<?=$this->instanceID ?>" class="<?=$this->classList ?> form-request">
    <div class="rn_Padding">
        <rn:container>
        <div class="message">
        #rn:msg:CUSTOM_MSG_SERVICES_REQUEST#
        </div>
                ...
                <div class="rn_Grid">
                    ...
                    <thead>
                            <tr>
                                ...
                                <th data-key="Fecha Cierre" class="rn_TextCenter" >Fecha Cierre</th>
                                <th data-key="link" class="rn_TextCenter" >Orden de Trabajo</th>
                        ...
                        <tbody>
                            <tr class="template" style="display:none;">
                                <td data-key="ID_DETALLE" data-format="text" class="rn_TextCenter">XXXXXX</td>
                                ...
                                <td data-key="link" data-format="node" class="rn_TextCenter">12345</td>
