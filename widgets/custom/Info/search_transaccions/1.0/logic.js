RightNow.namespace('Custom.Widgets.Info.search_transaccions');
Custom.Widgets.Info.search_transaccions = RightNow.Widgets.extend({     /**
     * Widget constructor.
     */
    constructor: function () {
        window.search_transaccions = this;
