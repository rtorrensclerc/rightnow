RightNow.namespace('Custom.Widgets.Info.PopUpMonitor');

Custom.Widgets.Info.PopUpMonitor = RightNow.Widgets.extend({
    /**
     * Widget constructor.
     * 
     */
    ...
    constructor: function () {
        window.widget_PopUpMonitor = this;
        var bloqued = "0";
        var nodeDom = '<div   align="center">';
        nodeDom += '<img width="1000px" height="641px" src="/euf/assets/images/POPUPCONMONITOREO.png"/>';
